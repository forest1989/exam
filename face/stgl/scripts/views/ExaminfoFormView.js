		...
		_DataForm = new mx.datacontrols.DataForm({
			...
			[
				[
					...
					{lineBreak:false,name:"examContentImg",caption:"* 试题[图片]",labelWidth:120,readOnly:false,id:"examContentImg",height:"30",editorType:"PictureManagerEditor",filePath:"\examContentImg",
					...
					{lineBreak:false,name:"optionsAImg",caption:"* 试题选项A[图片]",labelWidth:120,readOnly:false,id:"optionsAImg",height:"30",editorType:"PictureManagerEditor",filePath:"\optionsAImg",
						allowTypes:"jpg,png",displayCheckBox:true,filesLimit:"1",
						windowHeight: 400,
					    windowWidth: 500,
					    width:300,
					...
					{lineBreak:false,name:"optionsBImg",caption:"* 试题选项B[图片]",labelWidth:120,readOnly:false,id:"optionsBImg",height:"30",editorType:"PictureManagerEditor",filePath:"\optionsBImg",
						allowTypes:"jpg,png",displayCheckBox:true,filesLimit:"1",
						windowHeight: 400,
					    windowWidth: 500,
					    width:300,
					...
					{lineBreak:false,name:"optionsCImg",caption:"* 试题选项C[图片]",labelWidth:120,readOnly:false,id:"optionsCImg",height:"30",editorType:"PictureManagerEditor",filePath:"\optionsCImg",
						allowTypes:"jpg,png",displayCheckBox:true,filesLimit:"1",
						windowHeight: 400,
					    windowWidth: 500,
					    width:300,
					...
					{lineBreak:false,name:"optionsDImg",caption:"* 试题选项D[图片]",labelWidth:120,readOnly:false,id:"optionsDImg",height:"30",editorType:"PictureManagerEditor",filePath:"\optionsDImg",
						allowTypes:"jpg,png",displayCheckBox:true,filesLimit:"1",
						windowHeight: 400,
					    windowWidth: 500,
					    width:300,
					...
					{lineBreak:false,name:"optionsEImg",caption:"* 试题选项E[图片]",labelWidth:120,readOnly:false,id:"optionsEImg",height:"30",editorType:"PictureManagerEditor",filePath:"\optionsEImg",
						allowTypes:"jpg,png",displayCheckBox:true,filesLimit:"1",
						windowHeight: 400,
					    windowWidth: 500,
					    width:300,
					...
					{lineBreak:false,name:"optionsFImg",caption:"* 试题选项F(图片)",labelWidth:120,readOnly:false,id:"optionsFImg",height:"30",editorType:"PictureManagerEditor",filePath:"\optionsFImg",
						allowTypes:"jpg,png",displayCheckBox:true,filesLimit:"1",
						windowHeight: 400,
					    windowWidth: 500,
					    width:300,
