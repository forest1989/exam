...
testpaper.views.ManualRuleGridViewController = function(){
	var me = $extend(mx.views.ViewController);
	me.typeName="testpaper.views.ManualRuleGridViewController";
	me.getController=function(key){
		return me.getLinkViewController("testpaper.views."+key+"Controller");
	};
	me.getView = function(){
		if (me.view == null){
			me.view = new testpaper.views.ManualRuleGridView({ controller: me });
		}
		return me.view;
	};
