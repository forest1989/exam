...
testpaper.views.ManualRuleFormView=function(){
	...
	function _init_DetailToolBar(){		
		_DetailToolBar = new mx.controls.ToolBar({
			...
			height:"24",
			items:[
				{imageKey:"select",width:"60",id:"SelectButton",text:"选择",droppedDown:false,useSymbol:true,height:"20",onclick:me.controller._selectButton_onclick},
		...
		_DataForm = new mx.datacontrols.DataForm({
			...
			[
				[
					...
					me.findControlById('DataForm').getEditor('testPaperId').setValue(testpaper.testPaperId==undefined?"":testpaper.testPaperId);
//					me.findControlById('DataForm').getEditor('examTypeId').setValue(testpaper.examTypeId==undefined?"":testpaper.examTypeId);
//					me.findControlById('DataForm').getEditor('examIds').setValue(testpaper.examIds==undefined?"":testpaper.examIds);
