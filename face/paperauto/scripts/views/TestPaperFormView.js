...
paperauto.views.TestPaperFormView=function(){
	...
	function _init_DataForm(){
		var formEntityContainer = new mx.datacontainers.FormEntityContainer({
			...
			[
				...
				{readOnly:false,nullable:true,visible:true,valueType:"string",name:"answerTime",caption:"答题时间"},
	...
	function _init_DataGrid(){
		var gridEntityContainer = new mx.datacontainers.GridEntityContainer({
			baseUrl:paperauto.mappath("~/rest/automaticRule/"),
			loadMeta:false,
			iscID:"-1",
			primaryKey:"automaticRuleId"
		});
