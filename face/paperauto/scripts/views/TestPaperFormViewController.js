...
//paperauto、TestPaperFormView在编译时将自动替换为实际值，设计过程中不要随意修改

paperauto.views.TestPaperFormViewController = function(){
	var me = $extend(mx.views.ViewController);
	me.typeName="paperauto.views.TestPaperFormViewController";
	me.getController=function(key){
		return me.getLinkViewController("paperauto.views."+key+"Controller");
	};
	me.getView = function() {
		if (me.view == null) {
			me.view = new paperauto.views.TestPaperFormView({ controller: me });
		}
		return me.view;
	};
