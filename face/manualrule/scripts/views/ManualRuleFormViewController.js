...
manualrule.views.ManualRuleFormViewController = function(){
	var me = $extend(mx.views.ViewController);
	me.typeName="manualrule.views.ManualRuleFormViewController";
	me.getController=function(key){
		return me.getLinkViewController("manualrule.views."+key+"Controller");
	};
	me.getView = function(){
		if (me.view == null){
			me.view = new manualrule.views.ManualRuleFormView({ controller: me });
		}
		return me.view;
	};
