...
//manualrule、ManualRuleGridView在编译时将自动替换为实际值，设计过程中不要随意修改

manualrule.views.ManualRuleGridViewController = function(){
	var me = $extend(mx.views.ViewController);
	me.typeName="manualrule.views.ManualRuleGridViewController";
	me.getController=function(key){
		return me.getLinkViewController("manualrule.views."+key+"Controller");
	};
	me.getView = function(){
		if (me.view == null){
			me.view = new manualrule.views.ManualRuleGridView({ controller: me });
		}
		return me.view;
	};
	...
	me._NewButton_onclick = function() {
		var detailController = me.getController("ManualRuleFormView");
