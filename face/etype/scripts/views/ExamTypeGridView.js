...
etype.views.ExamTypeGridView=function(){
	...
	function _init_DataGrid(){
		...
		_DataGrid = new mx.datacontrols.DataGrid({
			columns:[
				{dataType:"string",name:"parentId",width:"120",caption:"上级分类",readOnly:false,id:"parentId",editorType:"DropDownEditor"},
				{dataType:"string",name:"typeName",width:"120",caption:"分类名称",readOnly:false,id:"typeName",editorType:"TextEditor",nullable:false},
				{dataType:"string",name:"typeCode",width:"120",caption:"分类编码",readOnly:false,id:"typeCode",editorType:"TextEditor",nullable:false}
			],
