...
etype.views.ExamTypeTreeView=function(){
	...
	function _init_DataTree(){
    	var treeEntityContainer = new mx.datacontainers.TreeEntityContainer({
            baseUrl: etype.mappath("~/rest/data/tree"),
            type:"remote"
        });
	...
	function _init_DataForm(){
		var formEntityContainer = new mx.datacontainers.FormEntityContainer({
			...
			meta:
			[
				{readOnly:false,nullable:false,visible:true,valueType:"string",name:"examTypeId",caption:"试题分类ID"},
				{readOnly:false,nullable:true,visible:true,valueType:"string",name:"parentId",caption:"父级编号"},
				{readOnly:false,nullable:true,visible:true,valueType:"string",name:"typeName",caption:"分类名称"},
				{readOnly:false,nullable:true,visible:true,valueType:"string",name:"typeCode",caption:"分类编码"},
		...
		_DataForm = new mx.datacontrols.DataForm({
			...
			[
				[
					"[默认]",true,
					{lineBreak:false,name:"examTypeId",caption:"试题分类ID",labelWidth:120,readOnly:false,id:"examTypeId",height:"22",editorType:"TextEditor",nullable:false},
					{lineBreak:false,name:"parentId",caption:"父级编号",labelWidth:120,readOnly:false,id:"parentId",height:"22",editorType:"TextEditor"},
					{lineBreak:false,name:"typeName",caption:"分类名称",labelWidth:120,readOnly:false,id:"typeName",height:"22",editorType:"TextEditor"},
					{lineBreak:false,name:"typeCode",caption:"分类编码",labelWidth:120,readOnly:false,id:"typeCode",height:"22",editorType:"TextEditor"},
