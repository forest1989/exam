...
//readtext、ReadingTextGridView在编译时将自动替换为实际值，设计过程中不要随意修改

readtext.views.ReadingTextGridViewController = function(){
	var me = $extend(mx.views.ViewController);
	me.typeName="readtext.views.ReadingTextGridViewController";
	me.getController=function(key){
		return me.getLinkViewController("readtext.views."+key+"Controller");
	};
	me.getView = function(){
		if (me.view == null){
			me.view = new readtext.views.ReadingTextGridView({ controller: me });
		}
		return me.view;
	};
