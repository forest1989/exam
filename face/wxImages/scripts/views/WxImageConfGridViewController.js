...
//wxImages、WxImageConfGridView在编译时将自动替换为实际值，设计过程中不要随意修改

wxImages.views.WxImageConfGridViewController = function(){
	var me = $extend(mx.views.ViewController);
	me.typeName="wxImages.views.WxImageConfGridViewController";
	me.getController=function(key){
		return me.getLinkViewController("wxImages.views."+key+"Controller");
	};
	me.getView = function(){
		if (me.view == null){
			me.view = new wxImages.views.WxImageConfGridView({ controller: me });
		}
		return me.view;
	};
