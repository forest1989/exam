package com.sgcc.exam.manualrule;
...
import com.sgcc.exam.manualrule.bizc.IManualRuleBizc;
...
public class ManualRuleController {
	...
	public @ColumnResponseBody List<ViewAttributeData> getPropertyMeta(@ColumnRequestParam("params") String[] filterPropertys) throws Exception {
		...
		datas = metadataService.getPropertyMeta(this.getClass(), "com.sgcc.exam.manualrule.po.ManualRule", filterPropertys);
		return datas;
	}
