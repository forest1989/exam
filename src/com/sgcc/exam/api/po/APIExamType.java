 ...
 * @date 2019-03-06
 */
public class APIExamType implements java.io.Serializable {
	...
	/** 构造方法 */
	public APIExamType(Integer examTypeId) {
	...
	public boolean equals(Object other) {
		...
		if ( !(other instanceof APIExamType) ) return false;
		APIExamType castOther = ( APIExamType ) other; 
